(function () {
  ...
  */
  ...
  extendNative(Array.prototype, "chain", fun (self, f) -> flatten .. map(f) $ this)

  console.log(map((fun (x, y) -> x * y), [1,2,3]))
  ...
  extendNative(Object.prototype, "map", fun (self, f) ->
    foldl(fun (o, k) -> set(o, k, f(self[k])), {}, Object.keys(self)))
