(function () {
    ...
    var Product$2519 = function () {
            function Product$2526(_0$2528) {
                if (!(this instanceof Product$2526)) {
                    return new Product$2526(_0$2528);
                }
            ...
            Product$2526.prototype.length = 1;
            var derived$2527 = Base$2513.derive({
                    name: 'Product',
                    constructor: Product$2526,
                    prototype: Product$2526.prototype,
                    variants: [{
                            name: 'Product',
                            constructor: Product$2526,
                            prototype: Product$2526.prototype,
    ...
    function getProduct$2525(x$2544) {
        return function getProduct$2525(x$2545) {
            return function (a0$2546) {
                var r0$2547 = Product$2519.unapply(a0$2546);
    ...
    module.exports = {
        Product: Product$2519,
        getProduct: getProduct$2525
    };
}());
