(function () {
  ...
  */
  ...
  // isObject :: a -> Bool
  fun isObject (obj) = match { Object => true, * => false }

  // isArray :: a -> Bool
  fun isArray  (obj) = match { Array  => true, * => false }

  // isNumber :: a -> Bool
  fun isNumber (obj) = match { Number => true, * => false }

  // isRegExp :: a -> Bool
  fun isRegExp (obj) = match { RegExp => true, * => false }

  // isString :: a -> Bool
  fun isString (obj) = match { String => true, * => false }

  // isNull :: a -> Bool
  fun isNull   (obj) = match { null   => true, * => false }

  // isUndef :: a -> Bool
  fun isUndef  (obj) = match { undefined => true, * => false }
