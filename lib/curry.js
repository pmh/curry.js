(function () {
  ...
  */
  ...
  fun Sum.prototype.empty (self) = Sum(0)

  fun Sum.prototype.concat (self, other) = match {
    (Sum(x), Sum(y)) => Sum(x + y)
  }
  ...
  fun Product.prototype.empty (self) = Product(1)

  fun Product.prototype.concat (self, other) = match {
  ...
  fun Max.prototype.empty (self) = Max(-Infinity)

  fun Max.prototype.concat (self, other) = match {
  ...
  fun Min.prototype.empty (self) = Min(Infinity)

  fun Min.prototype.concat (self, other) = match {
